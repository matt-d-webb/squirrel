  ...
  return (
    <Fragment>
      <Card className="card-box mb-5">
        <CardHeader>
          <div className="card-header--title font-size-lg text-dark">
            Tasks management
          </div>
          <div className="card-header--actions">
            ...
            <UncontrolledTooltip target="btnAddNewTooltip">
              Add new
            </UncontrolledTooltip>
            <Button
              size="sm"
            ...
            <UncontrolledTooltip target="btnCloseTooltip">
              Close
            </UncontrolledTooltip>
          </div>
        </CardHeader>
          ...
          <Table hover className="text-nowrap mb-0">
            ...
            <tbody>
              <tr>
                ...
                <td className="text-center">
                  <Button size="sm" color="link" id="btnViewDetailsTooltip">
                    <FontAwesomeIcon
                      icon={['fas', 'plus-circle']}
