  ...
  return (
    <Fragment>
            ...
            <div className="align-box-row">
              ...
              <div className="pl-2">
                <span className="pb-1 d-block">
                  John Doe{' '}
                  <small className="text-black-50">(john@example.com)</small>
                </span>
      ...
      <UncontrolledPopover
        ...
        <div className="card-footer bg-white p-3 text-center d-block">
          <Button
            ...
            color="primary"
            size="sm">
            <FontAwesomeIcon icon={['far', 'file-alt']} className="mr-1" />
            View History
          </Button>
        </div>
      </UncontrolledPopover>
      ...
      <UncontrolledPopover
        ...
        className="popover-custom-wrapper popover-custom-lg bg-night-sky border-0">
      ...
      <UncontrolledPopover
        ...
        className="popover-custom-wrapper popover-custom-lg bg-midnight-bloom border-0">
        <ListGroup flush className="text-left bg-transparent">
            ...
            <div className="card-body p-2">
              <div className="align-box-row align-items-start">
                <div className="font-weight-bold">
                  ...
                  <span className="font-size-xxl mt-1 text-white">586,356</span>
                </div>
                <div className="ml-auto">
