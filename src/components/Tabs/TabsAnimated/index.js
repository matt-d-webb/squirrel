...
const LivePreviewExample = () => {
  ...
  return (
    <Fragment>
      <Row>
        <Col xl="6">
          <div className="tabs-animated tabs-nav-first tabs-animated-shadow">
            <Nav tabs>
              <NavItem>
                <NavLink
      ...
      <Row>
        <Col xl="6">
          <div className="tabs-animated nav-tabs-success tabs-animated-shadow">
            <Nav tabs>
              <NavItem>
                <NavLink
                  className={clsx({ active: activeTab === '1' })}
        ...
        <Col xl="6">
          <div className="tabs-animated nav-tabs-dark tabs-animated-shadow">
            <Nav tabs>
              <NavItem>
                <NavLink
                  className={clsx({ active: activeTab === '1' })}
