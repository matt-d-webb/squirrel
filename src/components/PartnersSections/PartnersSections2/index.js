    ...
    <Fragment>
      <div className="bg-primary py-5">
        <div className="container pt-5">
          ...
          <div className="divider border-2 mt-4 mb-5 mx-auto border-white bg-white opacity-2 rounded-circle w-50" />
          <Row>
            <Col md="6" xs="12" lg="3" className="d-flex align-items-stretch">
