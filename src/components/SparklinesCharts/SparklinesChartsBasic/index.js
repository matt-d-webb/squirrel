...
export default function LivePreviewExample() {
  ...
  return (
    <Fragment>
      <Row>
        <Col md="6" xl="3">
          <Card className="card-box card-box-border-bottom border-danger card-shadow-danger mb-5">
        ...
        <Col md="6" xl="3">
          <Card className="card-box card-box-border-bottom border-success card-shadow-success mb-5">
            <div className="card-tr-actions">
              <Button
                size="sm"
                className="btn-pill text-uppercase px-4 font-size-xs"
        ...
        <Col md="6" xl="3">
          <Card className="card-box card-box-border-bottom border-warning card-shadow-warning mb-5">
            <div className="card-tr-actions">
              <Button
                size="sm"
                className="btn-pill text-uppercase px-4 font-size-xs"
        ...
        <Col md="6" xl="3">
          <Card className="card-box card-box-border-bottom border-info card-shadow-info mb-5">
            <div className="card-tr-actions">
              <Button
                size="sm"
                className="btn-pill text-uppercase px-4 font-size-xs"
